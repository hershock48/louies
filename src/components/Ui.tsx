...
/**
 * The placeholder used on Order and Photo Cookies, where the finished feature is a
 * later phase. It is deliberately not an apology and not a "coming soon" splash: it
